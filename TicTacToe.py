...
def minimax(current_board:      Board, \
    ...
    if is_maximizing:
        ...
        for move in current_board.getLegalMoves():
            new_board = current_board.getNewBoardWithMove(move)
            result = minimax(new_board, False, originating_player, current_depth+1, debug)
        ...
        for move in current_board.getLegalMoves():
            new_board = current_board.getNewBoardWithMove(move)
            result = minimax(new_board, True, originating_player, current_depth+1, debug)
